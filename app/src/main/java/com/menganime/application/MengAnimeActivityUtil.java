...
/**
 * 文件名：BenLiActivityUtil
 * 描    述：管理activity的工具类
 * 作    者：stt
 * 时    间：2017.4.19
 * 版    本：V1.0.0
 */
public class MengAnimeActivityUtil {
    ...
    private static MengAnimeActivityUtil instance;
    private long clickTime = 0; //记录第一次点击的时间

    private MengAnimeActivityUtil() {
     ...
     * @return
     */
    public static MengAnimeActivityUtil getInstance() {
        if (null == instance) {
            instance = new MengAnimeActivityUtil();
        }
        return instance;
    ...
    public void setFlag(boolean flag) {
        MengAnimeActivityUtil.flag = flag;
    }
