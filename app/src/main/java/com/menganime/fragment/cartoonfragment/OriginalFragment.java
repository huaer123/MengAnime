...
public class OriginalFragment extends BaseFragment implements OnItemClickListener,RecommendInterface {
    ...
    protected void setDate() {
        MyRequest.getRecommendList(this,pageIndex,10,3);
    }
    ...
    protected void init(View rootView) {
        ...
        recyclerView.setLoadingListener(new XpulltorefereshiRecyclerView.LoadingListener() {
            ...
            public void onLoadMore() {
                ...
                pageIndex++;
                MyRequest.getRecommendList(OriginalFragment.this,pageIndex,10,3);
            }
        });
    }
