...
public class HistoryFragment extends BaseFragment {
    ...
    public void onResume() {
        ...
        mList = SharedUtil.getCollectionHistoryListForHistory(context, SharedUtil.SAVECOLLECTIONHISTORYLIST);
    ...
    private void chapterMenu(final int position) {
        ...
        dialog_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedUtil.deleteHistory(context,SharedUtil.SAVECOLLECTIONHISTORYLIST,mList.get(position).getCartoonId());
                //mList = SharedUtil.getCollectionHistoryListForHistory(context, SharedUtil.SAVECOLLECTIONHISTORYLIST);
        ...
        dialog_deleteAll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedUtil.deleteAllHistory(context,SharedUtil.SAVECOLLECTIONHISTORYLIST);
                //mList = SharedUtil.getCollectionHistoryListForHistory(context, SharedUtil.SAVECOLLECTIONHISTORYLIST);
                mList.clear();
                adapter.notifyDataSetChanged();
                dialog.cancel();
